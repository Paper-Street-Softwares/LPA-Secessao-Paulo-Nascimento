...
export const infos = {
  ...
  domain: 'sucessao.psnascimento.adv.br', // Sem "www"
  phone: {
    ddd: '65',
...
const content = {
  texts: {
    ...
    hero: {
      ...
      title: (
        <h1>
          ...
          o Patrimônio e a Harmonia da sua Família
        </h1>
      ),
      subtitle: (
        <p>
          O prazo de 60 dias para abertura do inventário está correndo. Evite
          multas pesadas, o bloqueio de bens e conflitos familiares com uma
          condução jurídica estratégica e ágil.
        </p>
      ),
      ...
      ctaButtonText: 'QUERO FALAR COM UM ESPECIALISTA AGORA',
    ...
    features: {
      ...
      title: (
        <h1>
          Você perdeu um ente querido e agora
          <span className="destaque italic font-light"> enfrenta</span> a
          burocracia?
        </h1>
      ),
      subtitle:
        'Sabemos que este é um momento difícil. Além do luto, surge uma série de obrigações legais que, se negligenciadas, podem gerar prejuízos irreversíveis. Nossa missão é assumir a carga técnica para que você foque no que importa.',
      imgFeatures: imgFeatures,
      alt: 'imagem representativa da Seção Serviços',
      titleMessageFeature: 'Atuação firme',
      subtitleMessageFeature: 'na defesa do patrimônio familiar',
      cards: {
        card1: {
          title: 'Liberação de Valores',
          subtitle:
            'Atuação rápida para desbloqueio de contas bancárias e valores para custeio do próprio processo.',
          description: (
            <div>
              A_Definir
              <br />
        ...
        card2: {
          title: 'Venda de Bens',
          subtitle:
            'Gestão de alvarás judiciais para venda de imóveis ou veículos durante o processo, se necessário.',
          description: (
            <div>
              A_Definir
              <br />
        ...
        card3: {
          ...
          subtitle:
            'Intervenção técnica entre herdeiros para evitar que a disputa por bens destrua os laços familiares.',
          description: (
            <div>
              A_Definir <br />
              <br />
        ...
        card4: {
          title: 'Cálculo de Impostos (ITCMD)',
          subtitle:
            'Análise rigorosa para que você não pague nem um centavo a mais do que o estritamente legal.',
          description: (
            <div>
              A_Definir
              <br />
    ...
    planilha: {
      title: (
        <h1>
          Qual o{' '}
          <span className="destaque italic font-light">melhor caminho</span>{' '}
          para seu caso?
        </h1>
      ),
    },
    ...
    about: {
      ...
      paragraph: (
        <div>
          • <strong>Agilidade no Prazo:</strong> Evitamos a multa de até 20%
          sobre o imposto (ITCMD) por atraso na abertura.
          <br />• <strong>Segurança Patrimonial:</strong> Evitamos que erros na
          partilha causem a nulidade do processo no futuro.
          <br />• <strong>Redução de Estresse:</strong> O advogado atua como o
          ponto de equilíbrio técnico entre os herdeiros, filtrando emoções e
    ...
    ctaSecondary: {
      ...
      title: <h1>Não deixe o patrimônio da sua família estagnar.</h1>,
      subtitle:
        'O inventário parado é sinônimo de desvalorização de imóveis, multas e brigas. Vamos resolver isso hoje?',
      subtitleDireita: (
      ...
      ctaButtonText: 'AGENDAR REUNIÃO COM O ESPECIALISTA',
      ctaButtonAriaLabel:
        'Botão para chamada de ação para contato pelo whatsapp',
    },
    // blog: {
    ...
    faq: {
      ...
      questions: {
        question1: {
          question: 'Os bens estão bloqueados, como pagar o imposto?',
          answer:
            'Podemos solicitar ao juiz a venda de um bem ou o levantamento de valores em conta para pagar as custas sem que os herdeiros tirem do próprio bolso.',
        },
        question2: {
          question: 'Um dos herdeiros não quer assinar, o que fazer?',
          answer:
            'Entramos com o inventário judicial e o juiz o citará para se manifestar. Ninguém pode travar o direito dos outros herdeiros indefinidamente.',
        },
        question3: {
          question: 'Posso fazer o inventário se houver dívidas?',
          answer:
            'Sim. As dívidas são pagas pelo patrimônio do falecido. Se as dívidas forem maiores que os bens, os herdeiros não herdam a dívida, mas também não recebem bens.',
        },
        // question4: {
        //   question: '',
        //   answer: '',
